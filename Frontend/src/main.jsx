    ...
    <>
      ...
      <ClerkFailed>
        <div className="min-h-screen flex flex-col items-center justify-center gap-3 bg-base-300 text-base-content px-6 text-center max-w-md mx-auto">
          <p className="font-semibold text-error">Couldn&apos;t load authentication</p>
          <p className="text-sm opacity-80">
            Check your network, confirm this site URL is allowed in the Clerk dashboard (e.g.
            localhost with the correct port), and that <code className="text-xs bg-base-200 px-1 rounded">VITE_CLERK_PUBLISHABLE_KEY</code> is set.
          </p>
        </div>
      </ClerkFailed>
